    ...
    switch (os) {
      case "Windows": {
        setDownloadData({
          osName: os,
          downloadURL:
            "https://github.com/dgrco/TolariApp/releases/latest/download/Tolari-amd64-installer.exe",
      ...
      case "Linux": {
        setDownloadData({
          osName: os,
          downloadURL:
            "https://github.com/dgrco/TolariApp/releases/latest/download/Tolari.tar.gz",
        ...
        <div className="flex flex-col items-center px-6 mt-20 text-center">
          ...
          <div className="flex flex-col gap-4 items-center">
            <button
              ...
              className={`text-white px-8 py-3 rounded-2xl text-lg font-medium transition cursor-pointer ${
                downloadData === null
              ...
              onClick={(e) => {
                if (downloadData) {
                  handleDownloadAndRedirect(
                    ...
                    downloadData.relativeRedirectPath,
                  );
                }
              }}
            >
              Download{" "}
              {downloadData
                ? `for ${downloadData.osName}`
                : " Available on Windows and Linux (soon for macOS)"}
            </button>
            <Link
              href="/download"
              className="text-gray-500 opacity-85 text-sm underline"
            >
          ...
          <div className="grid md:grid-cols-2 gap-16 mt-16 max-w-5xl w-full">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 mt-2 max-w-md">
                Start with flashcards and easily jump to the planning board or
                the pomodoro timer. The dashboard gives you access to every tool
                you need, distraction-free.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 mt-2 max-w-md">
                Memorize faster with spaced repetition powered by the SM2
                algorithm. Whether it’s vocab, formulas, or key concepts, Tolari
                helps you remember what matters most.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 mt-2 max-w-md">
                Plan assignments and break down big projects with a simple
                drag-and-drop planning board. Stay organized without the chaos.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 mt-2 max-w-md">
                ...
                sessions. Study in focused bursts, recharge with breaks, and
